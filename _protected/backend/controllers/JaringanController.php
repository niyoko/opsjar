...
/**
 * JaringanController implements the CRUD actions for Jaringan model.
 */
class JaringanController extends Controller
{
    ...
    /**
     * Displays a single Jaringan model.
     * @param int $id ID
     * @return string
    ...
    /**
     * Updates an existing Jaringan model.
    ...
    /**
     * Deletes an existing Jaringan model.
    ...
    /**
     * Finds the Jaringan model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param int $id ID
     * @return Jaringan the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = Jaringan::findOne(['id' => $id])) !== null) {
            return $model;
        }
