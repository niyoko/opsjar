 ...
 */
class Xray extends \common\models\Xray
{
    public function getActionButton(){
        ...
        $btnDelete = Html::a('<i class="material-icons-round">delete</i>', $this->id ? '/xray/delete?id='.$this->id : '#', ['class' => 'btn', 'data-pjax' => 0, 'data-confirm' => 'Apakah anda yakin?', 'data-method' => 'post']);        
