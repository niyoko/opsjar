                        ...
                        <div class="d-flex bd-highlight">
                            ...
                            <div class="bd-highlight">
                                <div class="input-group" style="max-width:300px ;">
                                    <input type="search" id="provinsisearch-name" name="XraySearch[name]" class="form-control form-control-md" placeholder="Cari" value="<?= $searchModel->name ?>">
                    ...
                    <div class="col-md-12"> 
                        <div class="d-flex bd-highlight">
                            ...
                            <ul class="nav">
                                ...
                                <li class="nav-item pt-3">
                                    <a class="nav-link tab-active" href="/xray">Buletin</a>
                                </li>
                            </ul>
                            </div>
                            <div class="bd-highlight">
                                <div class="d-flex flex-row-center bd-highlight">
                                    <div class="d-flex pt-3">
                                        ...
                                        <?= Html::dropDownList('XraySearch[bulan]', $searchModel->bulan, Bimtek::optionsBulan(), ['class'=>'select form-select form-select-sm mr-2', 'id' => 'bulan-search' , 'prompt' => 'Semua']) ?>
                                    </div>
                                    <div class="d-flex pt-3">
                                        <label for="tahun-search" class="font-bold me-2 pt-1">Tahun</label>
                                        <?= Html::dropDownList('XraySearch[tahun]', $searchModel->tahun, Bimtek::optionsTahun(), ['class'=>'form-select form-select-sm select mr-2', 'id' => 'tahun-search' ]) ?>
                                    </div>
