    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group field-user-username required has-success">
                ...
                <input type="text" id="user-username" class="form-control" name="User[username]" maxlength="255" aria-required="true" aria-invalid="false" value="<?= $model->username ?>">
        ...
        <div class="col-md-6">
            <?= $form->field($model, 'role')->dropDownList(User::optionsRoles()) ?>        
        </div>
    </div>
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="input-group">
                ...
                <input type="password" id="user-password" class="form-control" name="User[password]" aria-required="true" aria-invalid="true" value="<?= $model->password ?>">
