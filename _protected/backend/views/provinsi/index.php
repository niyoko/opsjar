                        ...
                        <div class="d-flex bd-highlight">
                            ...
                            <div class="bd-highlight">
                                <div class="input-group" style="max-width:300px ;">
                                    <input type="search" id="provinsisearch-name" name="ProvinsiSearch[name]" class="form-control form-control-md" placeholder="Cari Provinsi" value="<?= $searchModel->name ?>">
                        ...
                        <div class="d-flex bd-highlight">
                            ...
                            <ul class="nav">
                                <li class="nav-item pt-3">
                                    <a class="nav-link tab-active active" aria-current="page" href="#">Peta Kerawanan</a>
                                </li>
                                <li class="nav-item pt-3">
                                    <a class="nav-link" href="/jaringan">Peta Jaringan</a>
                                </li>
                                <li class="nav-item pt-3">
                                    <a class="nav-link" href="/provinsi/x-ray">Buletin</a>
                                </li>
                            </ul>
                            </div>
                            <div class="bd-highlight">
                                <div class="d-flex flex-row-center bd-highlight">
                                    <div class="d-flex pt-3">
                                        ...
                                        <?= Html::dropDownList('ProvinsiSearch[bulan]', $searchModel->bulan, Bimtek::optionsBulan(), ['class'=>'select form-select form-select-sm mr-2', 'id' => 'bulan-search' , 'prompt' => 'Semua']) ?>
                                    </div>
                                    <div class="d-flex pt-3">
                                        <label for="tahun-search" class="font-bold me-2 pt-1">Tahun</label>
                                        <?= Html::dropDownList('ProvinsiSearch[tahun]', $searchModel->tahun, Bimtek::optionsTahun(), ['class'=>'form-select form-select-sm select mr-2', 'id' => 'tahun-search' ]) ?>
                                    </div>
            ...
            <?= GridView::widget([
                ...
                'columns' => [
                    ...
                    [
                        ...
                        'content' => function ($model, $key, $index, $column) {
                            return $model->dokumen_update_date ? Yii::$app->formatter->asDate($model->dokumen_update_date) :Yii::$app->formatter->asDate($model->updated_at);
                        }
                    ],
                    [
                        'label' => 'Tindakan',
